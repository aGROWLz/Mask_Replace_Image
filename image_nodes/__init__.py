from .image_ops import (
    ...
    PasteCroppedImageWithEdgeMarkerV2,
    PasteCroppedImageWithEdgeMarkerV3,
    MaskToCropPosition,
    CropPositionToMask,
    MaskEdgeMarker,
    MaskMosaic,
...
NODE_CLASS_MAPPINGS = {
    ...
    "PasteCroppedImageWithEdgeMarkerV2": PasteCroppedImageWithEdgeMarkerV2,
    "PasteCroppedImageWithEdgeMarkerV3": PasteCroppedImageWithEdgeMarkerV3,
...
NODE_DISPLAY_NAME_MAPPINGS = {
    ...
    "PasteCroppedImageWithEdgeMarkerV2": "贴回裁剪图像（边缘标记）V2",
    "PasteCroppedImageWithEdgeMarkerV3": "贴回裁剪图像（边缘标记）V3",
